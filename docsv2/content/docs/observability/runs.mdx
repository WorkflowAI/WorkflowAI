---
title: Runs
summary: Understand and manage individual agent executions, known as runs. This guide covers how to attach metadata for debugging, view run details, and search for specific interactions.
---
