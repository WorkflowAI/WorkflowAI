...
summary: Documentation on the price and latency data feature in the playground. Explains how to track costs, response times, and context window usage for each generation.
---
