...
summary: "Easily compare model outputs with diff mode. This feature highlights the differences between responses, making it simple to spot changes and evaluate model performance."
---
