---
title: Search (draft)
summary: Discover the upcoming advanced search capabilities for your observability data. Learn how you'll be able to filter runs, conversations, and insights to troubleshoot issues and analyze trends.
