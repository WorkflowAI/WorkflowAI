---
title: Conversations
summary: "Understand how multi-turn interactions are grouped into conversations. This guide explains both automatic and manual conversation tracking for better observability and debugging."
