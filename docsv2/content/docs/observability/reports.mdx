---
title: Reports (draft)
summary: Documentation on the Reports feature for analyzing agent performance. Explains how to use natural language to ask questions about your data and generate text-based reports.
