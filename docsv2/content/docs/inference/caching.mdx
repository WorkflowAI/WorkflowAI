---
title: Caching
summary: "Learn how to save time and money by caching API responses. This guide covers how caching works, the available caching options, and best practices for caching with image inputs."
