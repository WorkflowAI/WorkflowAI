---
title: Vercel AI SDK
summary: "Connect your Vercel AI SDK applications to WorkflowAI. Learn how to integrate your Vercel-based projects to leverage WorkflowAI's advanced features and model support."
