---
title: Caching
summary: Learn how to use caching to improve performance and reduce costs. This guide covers caching mechanisms, configuration options, and best practices for text and image-based requests.
