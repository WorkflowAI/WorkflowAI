---
title: Changelog
summary: Stay up-to-date with the latest changes and new features on the WorkflowAI platform. Our changelog provides a chronological record of updates, improvements, and new model integrations.
---
