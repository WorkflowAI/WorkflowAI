---
title: Conversations
summary: Understand how WorkflowAI groups agent interactions into conversations. This guide explains both automatic and manual methods for tracking multi-turn chats to improve observability and debugging.
