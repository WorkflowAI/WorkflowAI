---
title: Pydantic AI
summary: Learn how to integrate the PydanticAI library with WorkflowAI. This guide covers setup, structured outputs with Pydantic models, and using input variables for dynamic prompts.
