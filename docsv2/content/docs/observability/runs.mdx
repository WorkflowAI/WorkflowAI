---
title: Runs
summary: "Track every execution of your agents with runs. Learn how to view, search, and analyze individual runs to debug issues and understand your agent's behavior."
---
