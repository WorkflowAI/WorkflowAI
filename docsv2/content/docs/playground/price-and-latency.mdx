...
summary: Get real-time insights into model performance with price and latency data in the playground. Learn how to track costs, response times, and context window usage for each generation.
---
