---
title: User Feedback
summary: Learn how to collect and analyze user feedback to improve your AI agents. This guide covers the entire feedback loop, from generating feedback tokens to submitting and viewing user insights.
---
