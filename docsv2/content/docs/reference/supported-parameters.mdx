...
summary: Get a complete reference of all supported API parameters for the chat completions endpoint. Learn how to use parameters like `temperature`, `max_tokens`, and `stream`.
