...
TOOL_DEFINITIONS: list[ChatCompletionToolParam] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Edit the descriptions and examples within the output schema for the current agent. This allows updating field descriptions, examples, and other metadata without changing the schema structure.",
            "parameters": {
                "type": "object",
                "properties": {
                    "updated_output_schema": {
