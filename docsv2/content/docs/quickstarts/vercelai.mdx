---
title: Vercel AI SDK
summary: Integration guide for the Vercel AI SDK with WorkflowAI. Covers different strategies for passing custom parameters like input variables and trace IDs.
