...
WorkflowAI uses API keys for authentication. You can create and manage your API keys in your [organization settings](https://workflowai.com/keys), or via our MCP tool `create_api_key`.
