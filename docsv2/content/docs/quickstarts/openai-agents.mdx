---
title: OpenAI Agents
summary: "Leverage the OpenAI Agents SDK with WorkflowAI's powerful platform. This guide shows you how to integrate your existing OpenAI agents to gain enhanced observability, model flexibility, and more."
