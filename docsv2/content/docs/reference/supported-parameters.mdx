...
summary: "Get a complete reference of all supported API parameters for chat completions. This guide details every parameter, from `model` and `messages` to `temperature` and `metadata`."
