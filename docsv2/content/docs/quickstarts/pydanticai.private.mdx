---
title: Pydantic AI
summary: Integration guide for the PydanticAI library with WorkflowAI. Covers setup, structured outputs with Pydantic models, and using input variables for dynamic prompts.
