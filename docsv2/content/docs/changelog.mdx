---
title: Changelog
summary: "Stay up-to-date with the latest changes and improvements to WorkflowAI. Our changelog provides a running list of new features, bug fixes, and performance enhancements."
---
