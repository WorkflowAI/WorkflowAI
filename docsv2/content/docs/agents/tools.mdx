---
title: Tools
summary: "Extend your AI agent's capabilities with tools. Learn how to use hosted tools like web search and how to define your own custom tools for any use case."
---
