...
summary: Documentation on the Diff Mode feature in the playground. Explains how to visually highlight differences between model responses to compare their behavior.
---
