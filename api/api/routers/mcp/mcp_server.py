...
def description_for_fetch_run_details() -> str:
    return f"""<when_to_use>
    ...
    <returns>
    Returns comprehensive details of a specific WorkflowAI agent run:

    {format_schema_as_yaml_description(MCPRun)}
...
@_mcp.tool(description=description_for_fetch_run_details())
