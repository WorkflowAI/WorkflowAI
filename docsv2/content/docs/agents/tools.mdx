---
title: Tools
summary: "Extend your AI agent's capabilities with tools. Learn to use hosted tools like web search and browser, or define your own custom tools for maximum flexibility."
---
