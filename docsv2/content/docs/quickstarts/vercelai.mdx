---
title: Vercel AI SDK
summary: Learn how to integrate the Vercel AI SDK with WorkflowAI. This guide covers different strategies for passing custom parameters like input variables and trace IDs when using Vercel AI SDK.
