---
title: OpenAI Agents
summary: Learn how to integrate the OpenAI Agents SDK with WorkflowAI. This guide provides a step-by-step example for connecting your OpenAI agents to leverage WorkflowAI's features.
