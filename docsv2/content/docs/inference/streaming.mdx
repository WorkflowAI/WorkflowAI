---
title: Streaming
summary: "Improve user experience with real-time responses. This guide shows you how to enable streaming to receive and process model outputs as they are generated."
